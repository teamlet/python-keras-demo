...
#依赖　：sklearn,keras,random,load_face_dataset.py
import random
...
class Model:
    ...
    def build_model(self, dataset, nb_classes = 3):
        ...
        self.model.add(ZeroPadding2D((1,1)))                                #边界补０
        ...
        self.model.add(Dropout(0.5))   #0.5                                     #16 Dropout层
...
#训练模型
    ...
    MODEL_PATH = './model/new4.face.model.h5'
...
if __name__ == '__main__':    
    ...
    # model.train(dataset)
    # model.save_model(file_path = './model/f1.face.model.h5')
    #
    
# ##    #评估模型
    model = Model()
    model.build_model(dataset)#显示网络模型
